/* QupZillKa (2021-2026) http://github.com/dualword/QupZillKa License:GNU GPL v3*/
/* ============================================================
...
void AboutDialog::showAbout()
{
    ...
    if (m_aboutHtml.isEmpty()) {
        ...
        m_aboutHtml += "&copy; 2021-2026 Alexander Busorgin<br/>";
        m_aboutHtml += "<a href='https://github.com/dualword/QupZillKa'>https://github.com/dualword/QupZillKa</a><hr/>";
